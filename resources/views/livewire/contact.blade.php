    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form wire:submit.prevent="createNewMessage" action="#" class="space-y-8">
            <div>
                ...
                <input wire:model="form.email" type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="name@flowbite.com" >
                @error('form.email')
